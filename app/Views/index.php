                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-2">
                                        ...
                                        <select class="form-control" id="inputPekerjaanOrtu" name="pekerjaan_ortu" required>
                                            <option value="5|Tidak Bekerja">Tidak Bekerja</option>
                                            <option value="4|Buruh">Buruh</option>
                                            <option value="3|Pegawai">Pegawai</option>
                                            <option value="2|Wira Swasta">Wira Swasta</option>
                                            <option value="1|Lainya">Lainnya</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group col-md-2">
                                        ...
                                        <select class="form-control" id="inputPenghasilanOrtu" name="penghasilan_ortu" required>
                                            <option value="5|Tidak Bekerja">Tidak Bekerja</option>
                                            <option value="4|750.000">&lt;=750.000</option>
                                            <option value="3|1.250.000">&lt;=1.250.000</option>
                                            <option value="2|2.000.000">&lt;=2.000.000</option>
                                            <option value="1|3.000.000">&gt;=3.000.000</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group col-md-2">
                                        ...
                                        <select class="form-control" id="inputStatusAnak" name="status_anak" required>
                                            <option value="1|Anak Kandumg">Anak Kandung</option>
